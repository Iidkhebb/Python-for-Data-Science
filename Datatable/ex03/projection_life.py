...
def projection(income_data, life_expectancy_data):
    ...
    # Merging data on 'country' to get GDP per capita and life expectancy for the same countries
    merged_data = pd.merge(income_1900, life_expectancy_1900, on='country')

    # Plotting
    plt.figure(figsize=(14, 8))
    plt.scatter(merged_data['income_1900'], merged_data['life_expectancy_1900'], label='1900')
